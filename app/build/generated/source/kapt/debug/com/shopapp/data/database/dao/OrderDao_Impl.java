...
public final class OrderDao_Impl implements OrderDao {
  ...
  public Object markOrderAsDelivered(final String orderId, final String status,
      final long deliveredAt, final long updatedAt, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object getOrderCountByUser(final String userId,
  ...
  @Override
  public Object getTotalSpentByUser(final String userId,
