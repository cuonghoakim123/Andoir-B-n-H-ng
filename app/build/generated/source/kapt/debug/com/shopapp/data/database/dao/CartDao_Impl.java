...
public final class CartDao_Impl implements CartDao {
  ...
  @Override
  public Object deleteCartItem(final CartEntity cartItem,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  public Object addToCart(final String userId, final String productId, final int quantity,
      final Continuation<? super Unit> $completion) {
    return RoomDatabaseKt.withTransaction(__db, (__cont) -> CartDao.DefaultImpls.addToCart(CartDao_Impl.this, userId, productId, quantity, __cont), $completion);
  }

  @Override
  public Object deleteCartItemById(final String cartId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Object clearCart(final String userId, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  public Object updateCartItemQuantity(final String userId, final String productId,
      final int quantity, final long updatedAt, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object getTotalQuantity(final String userId,
      final Continuation<? super Integer> $completion) {
