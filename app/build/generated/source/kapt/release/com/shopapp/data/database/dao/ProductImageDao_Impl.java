...
public final class ProductImageDao_Impl implements ProductImageDao {
  ...
  @Override
  public Object insertImage(final ProductImageEntity image, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object deleteImage(final ProductImageEntity image, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object updateImage(final ProductImageEntity image, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  public Object updatePrimaryImage(final String productId, final String imageId,
    ...
    return RoomDatabaseKt.withTransaction(__db, (__cont) -> ProductImageDao.DefaultImpls.updatePrimaryImage(ProductImageDao_Impl.this, productId, imageId, __cont), arg2);
  }

  @Override
  public Object deleteImageById(final String imageId, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object clearPrimaryImages(final String productId, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object setPrimaryImage(final String imageId, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  public Object getImagesByProductId(final String productId,
      final Continuation<? super List<ProductImageEntity>> arg1) {
  ...
  public Object getPrimaryImageByProductId(final String productId,
      final Continuation<? super ProductImageEntity> arg1) {
  ...
  public Object getPrimaryImageUrlByProductId(final String productId,
      final Continuation<? super String> arg1) {
