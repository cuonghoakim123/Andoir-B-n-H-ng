...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull MaterialCardView rootView, @NonNull TextView discountBadge,
      @NonNull TextView originalPrice, @NonNull ImageView productImage,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((MaterialCardView) rootView, discountBadge, originalPrice,
          productImage, productName, productPrice, ratingBar, reviewCount);
    }
